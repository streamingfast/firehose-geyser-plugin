...
* Added INFO-level stage breadcrumbs around post-startup account-cache apply, first-send `process_upto`, and block/account FIFO encode/write so the next failure leaves a clearer trail.
